...
<h2>[青少年法律援助申请信息管理-添加]</h2>
<div class="line"></div>
<form action="InsYouthlawhelptables.naah" method="post" class="form form-horizontal responsive" id="demoform">
			<div class="row cl">
			<label class="form-label col-xs-2">姓名：</label>
			<div class="formControls col-xs-5">
				<input maxlength="20"  type="text" class="input-text radius" placeholder="姓名" name="name" id="name" datatype="*" nullmsg="姓名不能为空！">
			</div>
			...
			<div class="formControls col-xs-5">
				<textarea  class="textarea radius" name="lawReason" id="lawReason" datatype="*" nullmsg="理由不能为空！"></textarea>
			</div>
			<div class="col-xs-5"> </div>
            </div>
			...
			<div class="formControls col-xs-5">
				<input type="text" maxlength="11"  class="input-text radius" placeholder="监护人电话" name="tel" id="tel" datatype="tel" nullmsg="监护人电话不能为空！">
			</div>
			<div class="col-xs-5"> </div>
                        </div>
