...
<h2>[单身青年信息管理-添加]</h2>
<div class="line"></div>
<form action="InsSingleyouthtables.naah" method="post" class="form form-horizontal responsive" id="demoform">
			<div class="row cl">
			...
			<div class="formControls col-xs-5">
				<input type="text" class="input-text radius" maxlength="10"  placeholder="民族" name="nation" id="nation" datatype="*" nullmsg="民族不能为空！">
			</div>
			<div class="col-xs-5"> </div>
                        </div>
			...
			<div class="formControls col-xs-5">
				<input type="text" maxlength="50"  class="input-text radius" placeholder="公司单位" name="company" id="company" datatype="*" nullmsg="公司单位不能为空！">
			</div>
			<div class="col-xs-5"> </div>
                        </div>
			...
			<div class="formControls col-xs-5">
				<input type="text" maxlength="100"  class="input-text radius" placeholder="地址" name="address" id="address" datatype="*" nullmsg="地址不能为空！">
			</div>
			<div class="col-xs-5"> </div>
                    </div>
			...
			<div class="formControls col-xs-5">
				<input type="text" maxlength="20"  class="input-text radius" placeholder="微信" name="wechat" id="wechat" datatype="" nullmsg="微信不能为空！">
			</div>
			<div class="col-xs-5"> </div>
            </div>
			...
			<div class="formControls col-xs-5">
				<textarea  class="textarea radius"  name="chooseSexStandard" id="chooseSexStandard" datatype="*" nullmsg="择偶标准不能为空！"></textarea>
			</div>
			<div class="col-xs-5"> </div>
            </div>
			...
			<div class="formControls col-xs-5">
				<input type="text" maxlength="20"  class="input-text radius" placeholder="婚姻状况" name="marryStatus" id="marryStatus" datatype="*" nullmsg="婚姻状况不能为空！">
			</div>
			<div class="col-xs-5"> </div>
                        </div>
			...
			<div class="formControls col-xs-5">
				<textarea  class="textarea radius" name="personIntroduce" id="personIntroduce" datatype="" nullmsg="个人简介不能为空！"></textarea>
			</div>
			<div class="col-xs-5"> </div>
            </div>
