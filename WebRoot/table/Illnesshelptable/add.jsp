...
<h2>[医疗救助信息管理-添加]</h2>
<div class="line"></div>
<form action="InsIllnesshelptables.naah" method="post" class="form form-horizontal responsive" id="demoform">
			<div class="row cl">
			...
			<div class="formControls col-xs-5">
				<input type="text" maxlength="100"  class="input-text radius" placeholder="公司" name="company" id="company" datatype="*" nullmsg="公司不能为空！">
			</div>
			<div class="col-xs-5"> </div>
                        </div>
			...
			<div class="formControls col-xs-5">
				<textarea  class="textarea radius" name="illness" id="illness" datatype="*" nullmsg="疾病不能为空！"></textarea>
			</div>
			<div class="col-xs-5"> </div>
            </div>
			...
			<div class="formControls col-xs-5">
				<input type="text" maxlength="200"  class="input-text radius" placeholder="地址" name="address" id="address" datatype="*" nullmsg="地址不能为空！">
			</div>
			<div class="col-xs-5"> </div>
                        </div>
			...
			<div class="formControls col-xs-5">
				<input type="text"  maxlength="11" class="input-text radius" placeholder="座机" name="tel" id="tel" datatype="tel" nullmsg="座机不能为空！">
			</div>
			<div class="col-xs-5"> </div>
</div>
			...
			<div class="formControls col-xs-5">
				<input type="text" maxlength="11"  class="input-text radius" placeholder="手机" name="phone" id="phone" datatype="tel" nullmsg="手机不能为空！">
			</div>
			<div class="col-xs-5"> </div>
</div>
			...
			<div class="formControls col-xs-5">
				<textarea  class="textarea radius" name="note" id="note" datatype="" nullmsg="备注不能为空！"></textarea>
			</div>
			<div class="col-xs-5"> </div>
            </div>
