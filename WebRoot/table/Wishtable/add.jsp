...
<h2>[微心愿信息管理-添加]</h2>
<div class="line"></div>
<form action="InsWishtables.naah" method="post" class="form form-horizontal responsive" id="demoform">
			<div class="row cl">
			...
			<div class="formControls col-xs-5">
				<input type="text" maxlength="50"  class="input-text radius" placeholder="班级" name="class_" id="class_" datatype="*" nullmsg="班级不能为空！">
			</div>
			<div class="col-xs-5"> </div>
                        </div>
			...
			<div class="formControls col-xs-5">
				<input type="text" maxlength="100"  class="input-text radius" placeholder="社区:" name="communities" id="communities" datatype="*" nullmsg="社区不能为空！">
			</div>
			<div class="col-xs-5"> </div>
</div>
			...
			<div class="formControls col-xs-5">
				<textarea  class="textarea radius" name="wish" id="wish" datatype="" nullmsg="愿望不能为空！"></textarea>
			</div>
			<div class="col-xs-5"> </div>
            </div>
