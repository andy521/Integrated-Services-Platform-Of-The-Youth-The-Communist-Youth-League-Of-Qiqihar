...
<h2>[捐赠人员信息管理-添加]</h2>
<div class="line"></div>
<form action="InsIndexDonatePersonTables.naah" method="post" class="form form-horizontal responsive" id="demoform">
			<div class="row cl">
			...
			<div class="formControls col-xs-5">
				<input type="text"  maxlength="50"  class="input-text radius" placeholder="捐赠对象" name="donateObject" id="donateObject" datatype="*" nullmsg="捐赠对象不能为空！">
			</div>
			<div class="col-xs-5"> </div>
                        </div>
			...
			<div class="formControls col-xs-5">
				<input type="text" class="input-text radius" placeholder="捐赠金额" name="donateMoney" id="donateMoney" datatype="float" errormsg="请输入正确的捐赠金额！" nullmsg="捐赠金额不能为空！">
			</div>
			<div class="col-xs-5"> </div>
                        </div>
			...
			<div class="formControls col-xs-5">
				<input type="text"  maxlength="15"  class="input-text radius" placeholder="qq" name="qq" id="qq" datatype="" nullmsg="qq不能为空！">
			</div>
			<div class="col-xs-5"> </div>
</div>
			...
			<div class="formControls col-xs-5">
				<textarea  class="textarea radius"  name="claim" id="claim" datatype="*" nullmsg="要求不能为空！"></textarea>
			</div>
			<div class="col-xs-5"> </div>
            </div>
			...
			<div class="formControls col-xs-5">
				<textarea  class="textarea radius" name="wishes" id="wishes" datatype="" nullmsg="祝福寄语不能为空！"></textarea>
			</div>
			<div class="col-xs-5"> </div>
            </div>
        ...
        <input type="hidden" name="areasByCityId.areaId" id="areasByCity.areaId" value="${sessionScope.user.areasByCity.areaId}">
		...
		<div class="row cl">
			<div class="col-xs-10 col-xs-offset-2">
				<input class="btn btn-primary radius" type="submit" value="&nbsp;&nbsp;提交&nbsp;&nbsp;"><br>提交后如未显示请勿重复提交，因为信息需审核方可显示。
			</div>
		</div>
	</form>
