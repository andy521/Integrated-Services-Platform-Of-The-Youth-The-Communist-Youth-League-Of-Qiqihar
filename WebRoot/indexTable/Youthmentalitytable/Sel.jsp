...
<title>[青少年心理咨询信息]</title>
<link rel="stylesheet" type="text/css" href="static/h-ui/css/H-ui.css">
</head>
<body>

<div class="container">
<form action="indexYouthmentalitytables.naah" method="post" name="sel">
...
<h2>[青少年心理咨询信息]</h2>
	...
	<td>
	咨询方向：
	<input type="text" class="input-text radius size-M" placeholder="" name="askDirection" id="askDirection" value="${requestScope.askDirection}">
	</td>
	</tr>
	</table>
	</form>
<table class="table table-border table-bordered table-hover table-bg mt-10">
		...
		<tr>
			...
			<td class="col1 text-c ">${fn:substring(son.name,0,1)}某某</th>
