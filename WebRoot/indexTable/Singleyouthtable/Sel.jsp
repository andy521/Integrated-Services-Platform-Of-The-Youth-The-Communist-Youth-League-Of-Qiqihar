...
<div class="container">
<form action="indexSingleyouthtables.naah" method="post" name="sel">
...
<table class="table table-border table-bordered table-hover table-bg mt-10">
		<thead>
			<tr>
				...
				<th class="col3">学历</th>
				<th class="col3">单位</th>
				<th class="col3">择偶标准</th>
				<th class="col3">婚姻状况</th>
				<th class="col3">个人简介</th>
			</tr>
		</thead>
		<tbody>
		...
		<tr>
			...
			<td class="col2 text-c">${son.birthday}</td>
			<td class="col2 text-c">${son.education}</td>
			<td class="col2 text-c">${son.company}</td>
			<td class="col2 text-c">${son.chooseSexStandard}</td>
			<td class="col2 text-c">${son.marryStatus}</td>
			<td class="col2 text-c">${son.personIntroduce}</td>
